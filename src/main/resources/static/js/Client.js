function traerInformacionClientes() {
    $.ajax({
        url: "http://132.145.221.82:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionClientes() {
    ...
    $.ajax({
        ...
        url: "http://132.145.221.82:8080/api/Client/save",
...
function actualizarInformacionCliente(idElemento) {
    ...
    $.ajax({
        url: "http://132.145.221.82:8080/api/Client/update",
        type: "PUT",
        data: dataToSend,
...
function borrarCliente(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://132.145.221.82:8080/api/Client/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
